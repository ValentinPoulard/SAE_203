            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="proposer.php">
                        <div class="mb-3">
                            <label for="date" class="form-label">Date et heure de la mission *</label>
                        ...
                        <div class="mb-3">
                            <label for="commentaire" class="form-label">Détails de la mission</label>
                            <textarea name="commentaire" class="form-control" id="commentaire" rows="3"></textarea>
                        </div>
                        <div class="d-grid">
                            <button type="submit" name="submit" class="btn btn-primary">Créer la mission</button>
                        </div>
                    </form>
                </div>
